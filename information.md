...
- A dynamic optimization program to maximize the total monthly value from water allocation at Lewiston Dam for rice production and in-stream fish using the Fortran programming language: [Report with code in Appendix B](Hardy_Armbruster_Trinity_Water_Allocation_ENGR445.pdf)
